import { Home, History as HistoryIcon, Settings as SettingsIcon, Search as SearchIcon } from "lucide-react";
import { cn } from "@/lib/utils";

interface SidebarProps {
    activeView: 'search' | 'history' | 'settings';
    onNavigate: (view: 'search' | 'history' | 'settings') => void;
}

export function Sidebar({ activeView, onNavigate }: SidebarProps) {
    const NavItem = ({ view, icon: Icon, label }: { view: 'search' | 'history' | 'settings', icon: any, label: string }) => (
        <button
